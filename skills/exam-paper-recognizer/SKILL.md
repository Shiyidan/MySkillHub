...
3. 抽取增强版项目 JSON。
   ...
   - 尽量补充 `subject/question_type/difficulty/knowledge_points/skills/learning_analysis/generation_profile`。
...
5. 结构校验。
   ...
   - 校验基础字段、题号范围、选项、题干、图片字段和 SVG XML 结构。
  ...
  "questions": [
    {
      ...
      "knowledge_points": [
        {"name": "algebraic rearrangement", "taxonomy": "mathematics.algebra.rearrangement", "confidence": 0.9}
      ],
